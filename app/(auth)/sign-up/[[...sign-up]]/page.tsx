      ...
      <div className="flex w-full md:w-1/2 h-screen flex-col justify-center px-6 sm:px-12 md:px-16 lg:px-20 xl:px-28 bg-dark-2">
        <div className="mx-auto w-full max-w-[400px] flex flex-col gap-5">
          ...
          <div>
            ...
            <p className="text-zinc-400 mt-2 text-sm">Join MeetSync and start collaborating</p>
          ...
          {/* Links Block */}
          <div className="border-l-2 border-white/10 pl-4 py-1 flex flex-col gap-2 text-sm text-zinc-500">
            <div>
